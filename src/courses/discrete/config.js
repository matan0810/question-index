...
export const TRAPS = [
  ...
  { t: 'מספר העצים על $\\{1,\\ldots,n\\}$ שבהם $\\{1,2\\}$ היא צלע, או עם דרגות נתונות', n: 'חזר ב-2008 ב\' (q9), 2008 ג\' (q5,q6); נוסחת פרופר — עץ עם רצף דרגות $(d_i)$: $\\binom{n-2}{d_1-1,\\ldots,d_n-1}$' },
  { t: 'הושבת גברים ונשים בשורה/סביב שולחן כך שאין שני בני אותו מין סמוכים', n: 'חזר ב-2007 א\' (q6), 2007 ב\' (q3), 2008 ג\' (q8,q9), 2009 א\' (q8); להיזהר בין שורה למעגל (סיבובים)' },
  { t: 'מספרי קטלן בתחפושת: טריאנגולציות, מסלולי Dyck / בעיית ההצבעה, נוסחת נסיגה', n: 'חזר ב-2006 א\' (q13), 2007 א\' (q11), 2007 ב\' (q11), 2008 ב\' (q14), 2008 ג\' (q11) ובכמעט כל מועד מ-2013 עד 2025; $C_n=\\frac{1}{n+1}\\binom{2n}{n}$, עקרון השיקוף' },
  { t: 'סכום על $S_n$ של $\\binom{\\mathrm{fix}(\\sigma)}{k}$ (ספירת קבוצות נקודות שבת)', n: 'חזר ב-2007 ב\' (q8, $k=2$), 2008 ג\' (q10, $k=4$); ספירה כפולה: $\\sum_\\sigma\\binom{\\mathrm{fix}(\\sigma)}{k}=\\binom{n}{k}(n-k)!$' },
  { t: 'קיום תת-סדרה מונוטונית (ארדש-סקרש): סדרה באורך $>n^2$ או בנייה באורך $n^2$', n: 'חזר ב-2006 א\' (q15), 2007 ב\' (q10), 2009 א\' (q5) ובבחינות 2013–2025; סדרה באורך $n^2{+}1$ מכריחה תת-סדרה מונוטונית באורך $n{+}1$' },
  { t: 'תורת רמזי — $R(3,3)=6$ וצביעת צלעות $K_n$', n: 'לא מספיק להוכיח ש-$K_6$ מכיל משולש מונוכרומטי; חייבים גם להוכיח צמידות — שב-$K_5$ קיימת צביעה ב-2 צבעים ללא משולש ($C_5$ אדום, משלימו כחול). הנפוץ ביותר בגרפים — חזר כמעט בכל בחינה מ-2006 עד 2025' },
  { t: 'משפט הול: $|N(S)|\\ge|S|$ לכל $S\\subseteq A$, לא רק לאיברים בודדים', n: 'הוכחת היעדר שידוך: מצאו $S$ עם $|N(S)|<|S|$ (לרוב $|S|=2$ מספיק). הוכחת קיום שידוך: אינדוקציה על $|A|$ עם הבחנה בין המקרה שבו $|N(S)|>|S|$ לכל $S\\subsetneq A$ לבין המקרה הפוך' },
];
